...
int main()
{
	...
	unsigned char* image = SOIL_load_image("D:/UGit/LearnOpenGL/Content/container2.png", &w, &h, 0, SOIL_LOAD_RGB);
	...
	image = SOIL_load_image("D:/UGit/LearnOpenGL/Content/container2_specular.png", &w, &h, 0, SOIL_LOAD_RGB);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, w, h, 0, GL_RGB, GL_UNSIGNED_BYTE, image);
	glGenerateMipmap(GL_TEXTURE_2D);
	SOIL_free_image_data(image);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
